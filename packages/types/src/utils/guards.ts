import type { AutomationOutput, HTTPOutput, OSCOutput, TCPOutput } from '../definitions/core/Automation.type.js';
...
export function isTCPOutput(output: AutomationOutput): output is TCPOutput {
  return output.type === 'tcp';
}
